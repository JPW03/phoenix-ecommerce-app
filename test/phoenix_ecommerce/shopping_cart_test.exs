defmodule PhoenixEcommerce.ShoppingCartTest do
  use PhoenixEcommerce.DataCase

  alias PhoenixEcommerce.ShoppingCart

  describe "carts" do
    alias PhoenixEcommerce.ShoppingCart.Cart

    import PhoenixEcommerce.ShoppingCartFixtures
